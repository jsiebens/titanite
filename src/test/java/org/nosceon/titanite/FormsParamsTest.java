    ...
    protected Shutdownable configureAndStartHttpServer(HttpServer server) throws Exception {
        return
            server
                ...
                .register(POST, "/d", (r) -> Responses.ok().body(String.valueOf(r.body.asForm().getLong("p"))).toFuture())
                .register(POST, "/e", (r) -> Responses.ok().body(String.valueOf(r.body.asForm().getFloat("p"))).toFuture())
                .register(POST, "/f", (r) -> Responses.ok().body(String.valueOf(r.body.asForm().getDouble("p"))).toFuture())
                .register(POST, "/g", (r) -> Responses.ok().body(String.valueOf(r.body.asForm().getBoolean("p"))).toFuture())

                .register(POST, "/ma", (r) -> Responses.ok().body(String.valueOf(r.body.asForm().getStrings("p"))).toFuture())
